 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Agregar área</h4>
    ...
    <g:uploadForm action="guardar">
        <fieldset class="form">
            <label>Nombre del area: </label>
                <g:field name ="nom" type="text" placeholder="Mi area" required=""  maxlength="150" autofocus="true" /><br><br>

            <div class="col-xs-4"><label>Agregar una imagen: </label><br/>
                <img id="img_destino" style="width: 100%; height: 110px;" src="#"/>
            </div><br><br><br><br><br><br><br><br>           
                <input id="file_url" type="file" onchange="mostrarImagen(this)" name="myFile"/><br><br>

           <label>Acronimo del programa:</label>
              <g:field name="acro" type="text" maxlength="13" placeholder="Mi acronimo"/><br><br>
            <label>Nombre del programa: </label>
                <g:field name ="nomp" type="text"  maxlength="150" placeholder="Mi programa" /><br><br>
           <label>Encargado del Área:</label>
