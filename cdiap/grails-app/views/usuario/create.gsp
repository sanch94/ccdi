 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Agregar un usuario</h4>
    ...
    <g:form action="create">
        <fieldset class="form">
            <label>Nombre completo: </label><br>                      
                <input type="text" name="nu" placeholder="Nombre" maxlength="58" autofocus="true" autofocus="true"/><br><br>

            <label>Clave: </label><br/>
                <input type="text" name="cl" placeholder="clave de 6 digitos" minlength="6" maxlength="8"/><br><br>

            <label>Curp: </label><br>                      
                <input type="text" name="cu" placeholder="18 dígitos" minlength="18"  /><br><br>

            <label>Cargo o representación: </label><br/>
                <input type="text" name="c" placeholder="cargo" maxlength="99"/><br><br>
           ...
           <label>Agregar una localidad:</label>
