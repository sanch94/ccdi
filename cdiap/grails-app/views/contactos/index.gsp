 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Mis contactos</h4>
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tr>
            <td>
                <span class="tip">${o.id}
                    <div class="midiv"></div> 
                    <span>Detalles de este contacto<br/>
                        Id: ${o.id}<br />
                        Telefono Personal:<br/> ${o.telper}<br />
                        Telefono de la oficina:<br /> ${o.telmunic}<br />
                        Telefono publico:<br/> ${o.telcaseta}<br />
                        Correo personal:<br/>${o.correoper}<br />
                        Correo de la oficina:<br/>${o.correomuni}<br />
                        Fecha de este registro:<br/>${o.fregistro}<br />
                    </span>
                </span>
            </td>
            <td>${o.telper}</td>
            <td>${o.telmunic}</td>
            <td><g:link action="eliminar" id="${o.id}" onclick="return confirm('¿Está seguro? Se eliminaran todos los datos referentes a  ${o.telmunic}')">
