 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Agregar contacto</h4>
    ...
    <g:form action="create">
        <fieldset class="form">
            <label>Telefono personal </label><br>                      
                <input type="tel" name="tel" placeholder="953 000 0000" minlength="8" maxlength="10" autofocus="true" /><br><br>

            <label>Telefono de oficina: </label><br/>
                <input type="tel" name="tel2" placeholder="953 000 0000" minlength="8" maxlength="10"/><br><br>

           <label>Telefono Publico:</label><br>
           <span>(Obligatorio)</span><br>                    
                <input type="tel" name="tel3" placeholder="953 000 0000" required="" minlength="8" maxlength="10"/><br><br>


            <label>Correo personal: </label><br>      
                <g:field type="email" name="cor1" placeholder="abc@gmail.com" minlength="11" maxlength="100" title="correo privado" /><br><br>

           <label>Correo de oficina:</label><br>      
                <g:field type="email" name="cor2" placeholder="abc@gmail.com" minlength="11" maxlength="100" title="correo alternativo" /><br><br>  
        </fieldset>
