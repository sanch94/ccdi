 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Agregar localidad</h4>
...
<div class="panel-body">
    ...
    <g:form action="create">
        <fieldset class="form">
            <label>Calle numero ó paraje: </label><br>                      
                <input type="text" name="call" placeholder="calle numero ó paraje" maxlength="50" autofocus="true" /><br><br>

            <label>Nombre completo de la localidad: </label><br/>
                <input type="text" name="nl" placeholder="nombre de la localidad" maxlength="50"/><br><br>

           <label>Agregar un municipio:</label>
