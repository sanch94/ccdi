...
<html>
    ...
    <body>
        ...
        <div id="show-localidad" class="content scaffold-show" role="main">
            ...
            <f:display bean="localidad" />
            <g:form resource="${this.localidad}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.localidad}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
