 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Mis Usuarios</h4>
...
<div class="panel-body">
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tr>
            <td>
                <span class="tip">${o[0].id}
                    <div class="midiv"></div> 
                    <span>Detalles de este usuario<br/>
                        ID: ${o[0].id}<br />
                        NOMBRE:<br/> ${o[0].nombreu}<br />
                        CURP:<br/> ${o[0].curp}<br />
                        CLAVE:<br /> ${o[0].clave}<br />
                        CARGO:<br /> ${o[0].cargo}<br />
                        CALLE O PARAJE:<br /> ${o[1].callnoparaje}<br />
                        LOCALIDAD:<br /> ${o[1].nlocalidad}<br />
                        TIPO DE REGISTRO:<br />
                        <% if(o[0].tiporegistro==2){%>
                        <%="Permanente"%>
                        <%}else{%>
                        <%="Temporal"%>
                        <%}%><br/>
                        FECHA DE ESTE REGISTRO:<br/>${o[0].fechaderegistro}<br />
                    </span>
                </span>
            </td>
            <td>${o[0].nombreu}</td>
            <td>${o[0].cargo}</td>
            <td>${o[1].nlocalidad}</td>
            <td><g:link action="eliminar" id="${o[0].id}" onclick="return confirm('¿Está seguro? Se eliminaran todos los datos referentes a  ${o[0].nombreu}')">
        ...
        <tr><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0; height: 258px;"><!--img src="${resource(dir:'images',file:'favicon.ico')}" style="background:rgba(0,0,0.5,0); " /--></td> </tr>
        </tbody>
    </table>
    </div>
</div>
