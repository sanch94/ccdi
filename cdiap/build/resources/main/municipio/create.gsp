 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Agregar Municipio</h4>
...
<div class="panel-body">
    ...
    <g:form action="create">
        <fieldset class="form">
            <label>Nombre completo del municipio: </label><br>                      
                <input type="text" name="nm" placeholder="nombre del municipio" maxlength="50" autofocus="true" /><br><br>

            <label>Nombre completo del presidente: </label><br/>
                <input type="text" name="pre" placeholder="nombre del presidente" maxlength="50"/><br><br>

           <label>Agregar un contacto:</label>
