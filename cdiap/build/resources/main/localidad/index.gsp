 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Mis Localidades</h4>
        ...
        <tr>
            <td>
                <span class="tip">${o[0].id}
                    <div class="midiv"></div> 
                    <span>Detalles de esta localidad<br/>
                        Id: ${o[0].id}<br />
                        Calle numero ó paraje:<br/> ${o[0].callnoparaje}<br />
                        Nombre de la localidad:<br /> ${o[0].nlocalidad}<br />
                        Nombre del municipio:<br/> ${o[1].nmunicipio}<br />
                        Nombre del presidente:<br /> ${o[1].presidente}<br />
                        Fecha de este registro:<br/>${o[0].fehregistro}<br />
                    </span>
                </span>
            </td>
            <td>${o[0].callnoparaje}</td>
            <td>${o[0].nlocalidad}</td>
            <td>${o[1].nmunicipio}</td>
            <td><g:link action="eliminar" id="${o[0].id}" onclick="return confirm('¿Está seguro? Se eliminaran todos los datos referentes a  ${o[0].nlocalidad}')">
