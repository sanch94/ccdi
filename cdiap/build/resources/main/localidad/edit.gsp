 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Modificar datos de esta localidad</h4>
...
<div class="panel-body">
    ...
    <g:form action="modificar">
        <fieldset class="form">
            ...
            <label>Cambiar calle numero ó paraje: </label><br>                      
                <input type="text" name="call" value="${mod.callnoparaje}" placeholder="calle, numero ó paraje" maxlength="118" autofocus="true" /><br><br>

            <label>Cambiar nombre de la comunidad: </label><br/>
                <input type="text" name="nl" value="${mod.nlocalidad}" placeholder="nombre de la comunidad" maxlength="58"/><br><br>

           <label>Modificar municipio:</label>
                <g:select optionKey="id"  optionValue="nmunicipio" name="mu" from="${en}" value="id"/><br><br>
