    ...
    <g:form action="edit">
        <fieldset class="form">
            ...
            <label>Clave del cargo: </label>
                <g:field name ="ccarg" type="text"  required="" minlength="7" maxlength="12" autofocus="true" value="${mod.clavecargo}" /><br><br>
            <label>Nombre Completo: </label>
                <g:field name ="nom" type="text"  value="${mod.nombree}" required="" minlength="10" maxlength="59" /><br><br>
           <label>Clave Personal:</label>
              <g:passwordField name="contnueva" minlength="3" maxlength="12" placeholder="puede escribir la misma"/><br><br>
            <label>Correo Electrónico: </label>
                <g:field name ="cor" type="email" value="${mod.correoe}" minlength="11" maxlength="100" /><br><br>
