 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Mis Areas</h4>
        ...
        <tr>
            <td>
                <span class="tip">${o[0].id}
                    <div class="midiv"></div> 
                    <span>Detalles de esta area<br/>
                            <img src="${createLink(controller:'Area',action:'showImage',id:o[0].id)}"/><br/> 
                        ID: ${o[0].id}<br />
                        AREA:<br/> ${o[0].nombarea}<br />
                        ACRONIMO: ${o[0].acronimo}<br />
                        PROGRAMA:<br/> ${o[0].nombprog}<br />
                        ENCARGADO:<br/>${o[1].nombree}<br />
                        FECHA DE ESTE REGISTRO:<br/>${o[0].fechareg}<br />
                    </span>
                </span>
            </td>
            <td>${o[0].nombarea}</td>
            <td>${o[0].nombprog}</td>
            <td><g:link action="eliminar" id="${o[0].id}" onclick="return confirm('¿Está seguro? Se eliminaran todos los datos referentes a  ${o[0].nombarea}')">
