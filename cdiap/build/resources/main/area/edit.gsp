 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Modificar datos de esta área</h4>
...
<div class="panel-body">
    ...
    <!--EN CLASES-->
    <g:uploadForm action="modificar">
        <fieldset class="form">
            <g:hiddenField name="id" type="number" value="${mod.id}"/>
            <label>Nombre del area: </label>
                <g:field name ="nom" type="text" placeholder="Mi area" value="${mod.nombarea}"  maxlength="150" autofocus="true" /><br><br>
            
            <div class="col-xs-4"><label>Imagen anterior: </label><br/>
                    <img class="para-img" src="${createLink(controller:'Area',action:'showImage',id:mod.id)}"/>
            </div>

            <div class="col-xs-4"><label>Nueva imagen: </label><br/>
                <img class="para-img" id="img_destino" " src="#"/>
            </div>
            <div class="col-xs-4"><div class="para-img"></div></div>                               
                <input id="file_url" type="file" onchange="mostrarImagen(this)" name="myFile"/><br>

           <label>Cambiar Acronimo:</label>
              <g:field name="acro" type="text" maxlength="13" placeholder="Mi acronimo" value="${mod.acronimo}"/><br><br>
            <label>Cambiar programa: </label>
                <g:field name ="nomp" type="text"  maxlength="150" placeholder="Mi programa" value="${mod.nombprog}"/><br><br>
           <label>Cambiar Encargado:</label>
                <g:select optionKey="id"  optionValue="nombree" name="encarg" from="${en}" value="id"/><br><br>  
        </fieldset>
