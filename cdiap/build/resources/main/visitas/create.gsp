 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Agregar una Visita</h4>
    ...
    <g:form action="create">
        <fieldset class="form">
            <label>Asunto: </label><br>                      
                <input type="text" name="asu" placeholder="Escriba..." maxlength="99" autofocus="true" autofocus="true"/><br><br>

            <label>Numero de acompañantes: </label><br/>
                <input type="number" name="na" placeholder="123456789..." max="20"/><br><br>

            <label>Comentarios: </label><br>                      
                <input type="text" name="co" placeholder="Comente aqui..." maxlength="254"  /><br><br>

           <label>Agregar un usuario:</label>
                <g:select optionKey="id"  optionValue="nombreu" name="usu" from="${en}" value="id"/><br><br>

           <label>Agregar area donde se dirije:</label>
                <g:select optionKey="id"  optionValue="nombarea" name="ar" from="${are}" value="id"/><br><br>
