 ...
 <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Mis Visitas</h4>
...
<div class="panel-body">
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tr>
            <td>
                <span class="tip">${o[0].id}
                    <div class="midiv"></div> 
                    <span>Detalles de esta visita<br/>
                        Id: ${o[0].id}<br />
                        Asunto:<br/> ${o[0].asunto}<br />
                        Numero de acompañantes:<br/> ${o[0].nacompanantes}<br />
                        Comentarios:<br /> ${o[0].comentario}<br />
                        Area:<br /> ${o[1].nombarea}<br />
                        Acronimo:<br /> ${o[1].acronimo}<br />
                        Programa:<br /> ${o[1].nombprog}<br />
                        Nombre del usuario:<br /> ${o[2].nombreu}<br />
                        Cargo:<br /> ${o[2].cargo}<br />
                        Fecha de este registro:<br/>${o[0].fechadregistro}<br />
                    </span>
                </span>
            </td>
            <td>${o[0].asunto}</td>
            <td>${o[0].nacompanantes}</td>
            <td>${o[1].nombarea}</td>
            <td>${o[1].acronimo}</td>
            <td>${o[1].nombprog}</td>
            <td>${o[2].nombreu}</td>
            ...
            <td><g:link action="eliminar" id="${o[0].id}" onclick="return confirm('¿Está seguro? Se eliminaran todos los datos referentes a  ${o[0].asunto}')">
        ...
        <tr><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0;"></td><td style="border:0; height: 258px;"><!--img src="${resource(dir:'images',file:'favicon.ico')}" style="background:rgba(0,0,0.5,0); " /--></td> </tr>
        </tbody>
    </table>
    </div>
</div>
